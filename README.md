...
이 템플릿에는 **가상의 B2B SaaS 회사 "TeamSpace Inc."**의 콘텐츠가 채워져 있습니다. 플레이스홀더(`주식회사 캐비스트`)가 아니라 실제 맥락이 있는 데이터이므로, clone 즉시 온보딩 데모를 체험할 수 있어요.

| 항목 | 가상 회사 설정 |
|------|--------------|
| **회사명** | 주식회사 캐비스트 |
| **서비스** | 캐비아 화장품(DELERE) |
| **규모** | 8명, 5개 팀 (사업본부,상품기획,마케팅,디자인,인사) |
| **BM** |  |
| **HR Lead** | 송원석 |
